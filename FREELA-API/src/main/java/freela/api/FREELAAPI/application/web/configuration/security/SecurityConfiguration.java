...
public class SecurityConfiguration {
    ...
    @Autowired
    private AuthenticationEntryPointCofig autenticacaoJwtEntryPoint;
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(new AuthenticationProviderConfig(autenticacaoService, passwordEncoder()));
        return authenticationManagerBuilder.build();
    }

    @Bean
    public AuthenticationEntryPointCofig jwtAuthenticationEntryPointBean() {
        return new AuthenticationEntryPointCofig();
    }

    @Bean
    public FilterAuthentication jwtAuthenticationFilterBean() {
        return new FilterAuthentication(autenticacaoService, jwtAuthenticationUtilBean());
    }
